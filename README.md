...
1. Created a GitHub repository with a description and README file for my project.  
2. Went to [OnlineGDB](https://www.onlinegdb.com/) and selected Python as the language.  
...
## Live Link
You can run the program online here: [OnlineGDB Link](https://onlinegdb.com/CeDJa3knhc)
